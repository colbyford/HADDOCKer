...
#
# calculate average cluster i-RMSD from target
#
set atoms='CA,C2,P'
...
foreach iclu (file.list_clust[0-9] file.list_clust[0-9][0-9])
  head -$nmb $iclu >$iclu'_best'$nmb
  echo ' ' >>$iclu'_best'$nmb
end
set totline=$nmb
@ totline+=8
foreach iclu (file.cns_clust[0-9] file.cns_clust[0-9][0-9])
