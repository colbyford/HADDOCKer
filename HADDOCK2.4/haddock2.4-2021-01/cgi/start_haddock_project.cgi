...
# HADDOCK
# saves the information needed for starting a new project
#
##########################################################################################
...
foreach $key (sort keys(%input)) {
    if ( $key eq submit_save ) {
	print "Content-type: text/HADDOCK\n\n";
    }
}
...
print "<h2>Parameters for the start:</h2>\n";
print "<BR>\n<h4><!-- HADDOCK -->\n";
...
# HTML formats in PrintVariables changed by Jens Linge, 25.5.98
